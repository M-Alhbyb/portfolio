...
(
    ...
    'إي تمكين 365 منصة تدخل تكيفي للأطفال ذوي التحديات النمائية والسلوكية.
...
('experience', 'Dec 2025 - Present', 'مطور ويب كامل', 'شركة مسيرتكم', 'قاد تطوير المنصة الأساسية التي تخدم أكثر من 500 مستخدم باستخدام Python و Django. حسّن سير عمل DevOps مما قلل وقت النشر بنسبة 60%. حسّن أداء PostgreSQL و Redis مما قلل زمن الاستعلام بنسبة 40%. أضاف ميزات مدعومة بالذكاء الاصطناعي.', 'الرياض، السعودية', 'عن بعد', 'https://cevehat.com', NULL, 1, 'ar'),
('experience', 'Jan 2026 - Present', 'قائد البنية التحتية و DevOps', 'شركة فنجان للاستثمار', 'أدار عمليات استعادة البنية التحتية في قطر. نقل 28 موقعاً مخترقاً إلى بنية AWS التحتية. أمّن أكثر من 25 نظام إنتاج. نسّق إدارة الأزمات التقنية لمحفظة مؤسسية.', 'الدوحة، قطر', 'عن بعد', 'https://finjan.vc', NULL, 2, 'ar'),

...
-- AI & Automation
('LLM Integrations', 'AI & Automation', 75, NULL, 1),
('AI Agents', 'AI & Automation', 75, NULL, 2),
('MCP Workflows', 'AI & Automation', 70, NULL, 3),
('Prompt Engineering', 'AI & Automation', 85, NULL, 4),
('Gemini API Integration', 'AI & Automation', 80, NULL, 5),
('AI Automation', 'AI & Automation', 80, NULL, 6),
('AI-Assisted Development', 'AI & Automation', 90, NULL, 7),
('Spec-Driven Development', 'AI & Automation', 80, NULL, 8),
-- Architecture & Concepts
('System Architecture', 'Architecture & Concepts', 85, NULL, 1),
('Async Programming', 'Architecture & Concepts', 80, NULL, 2),
('ERP Systems', 'Architecture & Concepts', 76, NULL, 3),
('POS Systems', 'Architecture & Concepts', 82, NULL, 4),
('Financial Systems', 'Architecture & Concepts', 78, NULL, 5),
('API Integration', 'Architecture & Concepts', 86, NULL, 6),
('Database Design', 'Architecture & Concepts', 86, NULL, 7),
-- Backend
...
('AI Integration', 'Backend', 72, NULL, 9),
-- Database
('PostgreSQL', 'Database', 88, NULL, 1),
('MySQL', 'Database', 76, NULL, 2),
-- Frontend
('HTML', 'Frontend', 88, NULL, 1),
('CSS', 'Frontend', 85, NULL, 2),
('JavaScript', 'Frontend', 82, NULL, 3),
('TailwindCSS', 'Frontend', 84, NULL, 4),
('Bootstrap', 'Frontend', 72, NULL, 5),
('HTMX', 'Frontend', 80, NULL, 6),
('React', 'Frontend', 65, NULL, 7),
-- DevOps
('Git', 'DevOps', 90, NULL, 1),
('Linux', 'DevOps', 93, NULL, 2),
('Docker', 'DevOps', 88, NULL, 3),

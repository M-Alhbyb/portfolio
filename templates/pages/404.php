...
<body class="min-h-screen bg-[#0b1120] text-white font-sans antialiased flex items-center justify-center">
    <div class="text-center max-w-lg mx-auto px-4">
        ...
        <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-red-500 mx-auto mb-6 rounded-full"></div>
        <h1 class="text-2xl font-semibold mb-3"><?= \App\Helpers\Language::t('error.404_title') ?></h1>
        <p class="text-gray-400 mb-8"><?= \App\Helpers\Language::t('error.404_message') ?></p>

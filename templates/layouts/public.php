...
<body class="min-h-screen font-mono bg-cat-base text-cat-text">
    <div x-data="navMenu" class="md:hidden fixed inset-x-0 top-0 z-50">
        <div class="bg-cat-crust border-b border-cat-surface1 h-10 flex items-center px-3 text-xs font-mono text-cat-subtext0">
            ...
            <span class="ml-2 text-cat-overlay2">~/portfolio</span>
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
            ...
            <div class="px-3 py-3 space-y-1">
                <a href="/" @click="close" class="block px-3 py-2 text-sm text-cat-subtext0 hover:text-cat-lavender hover:bg-cat-surface0 font-mono">~/home</a>
                <a href="/projects" @click="close" class="block px-3 py-2 text-sm text-cat-subtext0 hover:text-cat-lavender hover:bg-cat-surface0 font-mono">~/projects</a>
                <a href="/blog" @click="close" class="block px-3 py-2 text-sm text-cat-subtext0 hover:text-cat-lavender hover:bg-cat-surface0 font-mono">~/blog</a>
                <a href="/about" @click="close" class="block px-3 py-2 text-sm text-cat-subtext0 hover:text-cat-lavender hover:bg-cat-surface0 font-mono">~/about</a>
                <a href="/contact" @click="close" class="block px-3 py-2 text-sm text-cat-subtext0 hover:text-cat-lavender hover:bg-cat-surface0 font-mono">~/contact</a>
            </div>
        </div>
    </div>

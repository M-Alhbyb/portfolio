...
(3, 'Media & Organizing Volunteer', 'Khatwa Charity Foundation', 'Participated in media and organizational activities of the foundation at Omdurman Islamic University. Contributed to event management and graphic design for activities and initiatives.', 'Omdurman, Sudan', '2021', '2021', NULL, 3),
(4, 'Deputy Media Officer', 'Arabic Language College Committee', 'Elected as Deputy Media Officer. Designed media materials for student activities. Contributed to organizing student reception, cultural activities, and the college sports league.', 'Omdurman Islamic University', '2022', '2022', NULL, 4)
ON CONFLICT DO NOTHING;

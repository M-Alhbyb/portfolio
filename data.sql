...
(
    ...
    'ezoo-pos-system-ar',
    'نظام نقاط بيع وإدارة مخزون خلفي تم بناؤه لصالح شركة Rayon Energy لمعدات الطاقة الشمسية، مع التركيز على الدقة المالية وإدارة المخزون والعمليات غير المتزامنة.',
    '**المستودع:** [GitHub - M-Alhbyb/ezoo_pos](https://github.com/M-Alhbyb/ezoo_pos)

EZOO POS هو نظام خلفي لنقاط البيع وإدارة المخزون صُمم لصالح شركة Rayon Energy المتخصصة في معدات الطاقة الشمسية واللوازم الكهربائية.

طُوّر الإطار باستخدام FastAPI مع عمليات قاعدة بيانات غير متزامنة لدعم الأداء القابل للتوسع.

كان التركيز الأساسي على منع أخطاء الدقة المالية باستخدام الحسابات العشرية بدلاً من حسابات الفاصلة العائمة.

يتضمن النظام إدارة المخزون، ومعالجة المعاملات، وحساب الرسوم، ودعم ضريبة القيمة المضافة، وسجلات مبيعات غير قابلة للتعديل.',
    '["FastAPI","Python","PostgreSQL","SQLAlchemy","Alembic","Pydantic","WebSockets","Pytest"]',
    'بنية FastAPI معيارية مع طبقات API منفصلة ومخططات ونماذج وخدمات. PostgreSQL كمصدر رئيسي للمعلومات. تكامل SQLAlchemy غير المتزامن باستخدام asyncpg. نظام ترحيل Alembic. حسابات مالية عشرية لدقة المعاملات.',
    'بنية تركز على الموثوقية وقابلية الصيانة. PostgreSQL و Alembic لاتساق المخطط. صُممت مع قابلية التوسع والاختبار كأولويات.',
    'منع أخطاء دقة الفاصلة العائمة في سير العمل المالي. تصميم سير عمل معاملات غير قابل للتعديل. الحفاظ على سلامة البيانات أثناء العمليات غير المتزامنة.',
    'بناء نظام خلفي مناسب لأنظمة البيع بالتجزئة. تنفيذ سير عمل مالي موثوق. إنشاء بنية API قابلة للتوسع.',
    NULL,
    'https://github.com/M-Alhbyb/ezoo_pos',
    'published',
    true,
...
(
    ...
    'نظام ERP مخصص لمتجر حقيقي باستخدام Laravel و React مع لوحات تحكم متعددة الأدوار وأدوات إدارة تشغيلية.',
    '*نشر إنتاجي خاص - مشروع عميل.*

Rose Gate ERP هو نظام متكامل لإدارة الأعمال طُوّر من الصفر لصالح عميل حقيقي يدير متجر بيع بالتجزئة.

بُني النظام باستخدام Laravel للجهة الخلفية و React للجهة الأمامية، مع لوحات تحكم وأدوات إدارة تشغيلية لعدة أدوار.

يشمل المشروع التحكم في الوصول على أساس الأدوار، ولوحات تحكم إدارية، وإدارة بيانات الأعمال، وسير عمل داخلي لتبسيط عمليات المتجر.',
    '["Laravel","React","MySQL","REST API"]',
    'نظام خلفي Laravel مع بنية RESTful API. واجهة أمامية React بمكونات لوحة تحكم قابلة لإعادة الاستخدام. نظام صلاحيات متعدد الأدوار. قاعدة بيانات MySQL.',
    'طُوّر لعميل حقيقي ونُشر في بيئة إنتاجية. تسليم متكرر يركز على احتياجات العمل. أولوية لسهولة الاستخدام والبساطة.',
    'تصميم سير عمل قائم على الأدوار. هيكلة تكامل الواجهات بشكل نظيف. بناء سير عمل ERP قابل للصيانة.',
    'نشر النظام بنجاح لعمليات متجر حقيقية. تحسين التنظيم التشغيلي. تقديم حل ERP مخصص.',
    NULL,
    NULL,
    'published',
    true,
...
(
    ...
    'منصة إدارة مخزون مدعومة بالذكاء الاصطناعي مع تتبع المعاملات وتعريب وتحليلات تنبؤية.',
    '**المستودع:** [GitHub - M-Alhbyb/Django_Inventory_System](https://github.com/M-Alhbyb/Django_Inventory_System)

منصة مؤسسية لإدارة المخزون صُممت للتجار والمندوبين مع تحليلات بالذكاء الاصطناعي وتقارير تشغيلية.

يدمج النظام أدوات Google Gemini AI للاستعلامات باللغة الطبيعية ونماذج Prophet للتنبؤ بالسلاسل الزمنية.

يشمل إدارة المعاملات، وتتبع ديون التجار، وحسابات المخزون، ولوحات تحكم، وتعريب كامل للواجهة.',
    '["Django","Python","PostgreSQL","Google Gemini API","Prophet","Celery","Redis","TailwindCSS"]',
    'بنية Django معيارية مع مجالات أعمال منفصلة. طبقة ذكاء اصطناعي تدمج Gemini APIs. تكامل Prophet للتنبؤ. Celery و Redis للمعالجة غير المتزامنة. دعم RTL.',
    'صُممت لقابلية الصيانة والتوسع. بنية معيارية وخدمات قابلة لإعادة الاستخدام. مراعاة سير عمل المخزون الحقيقي.',
    'بناء سير عمل مدعوم بالذكاء الاصطناعي. إدارة اتساق المعاملات. دعم RTL والتصديرات المحلية.',
    'أتمتة تحليل المخزون والتنبؤ. تحسين التقارير التشغيلية. تمكين رؤى أعمال بالذكاء الاصطناعي.',
    NULL,
    'https://github.com/M-Alhbyb/Django_Inventory_System',
    'published',
    true,
...
(
    ...
    'منصة تجارة إلكترونية كاملة مع تحكم في الوصول متعدد الأدوار و REST API ونشر إنتاجي.',
...
منصة تجارة إلكترونية كاملة تدعم العملاء والموظفين والإدارة بسير عمل منفصلة.

يشمل التحكم في الوصول على أساس الأدوار، نقاط نهاية REST API، سلة تسوق ديناميكية، إدارة منتجات، وتصفية متقدمة.

نُشر النظام وهيكل بتطبيقات Django معيارية للصيانة والتوسع.',
    '["Django","PostgreSQL","Django REST Framework","Bootstrap"]',
    'بنية Django معيارية مع مجالات تطبيق منفصلة. طبقة REST API باستخدام DRF. تحكم وصول متعدد الأدوار. قاعدة بيانات PostgreSQL.',
    'نُشر على بنية تحتية سحابية. قابلية التوسع والصيانة. مهيكل لتكاملات API مستقبلية.',
    'تصميم سير عمل قابل للتوسع. هيكلة نقاط نهاية API قابلة لإعادة الاستخدام. إدارة أنظمة المنتجات.',
    'تقديم منصة جاهزة للإنتاج. تنفيذ أنظمة API ومصادقة قابلة لإعادة الاستخدام.',
    NULL,
    'https://django-e-commerce-app-34ro.onrender.com',
    'published',
    false,
...
(
    ...
    'لوحة تحكم إدارية لبنية Jitsi Meet التحتية مع مصادقة JWT ومراقبة في الوقت الفعلي.',
    '**المستودع:** [GitHub - M-Alhbyb/jitsi-dashboard](https://github.com/M-Alhbyb/jitsi-dashboard)

لوحة تحكم بـ Django لإدارة بنية Jitsi Meet ومراقبة عمليات الاجتماعات.

يدمج Jitsi APIs لإدارة الاجتماعات ومراقبة المشاركين ومصادقة JWT.

يشمل معالجة webhooks وأدوات مراقبة تشغيلية.',
    '["Django","JWT","REST APIs","Jitsi Meet APIs"]',
    'نظام خلفي Django مع تكاملات API. مصادقة JWT. مراقبة في الوقت الفعلي. معالجة webhooks.',
    'تركيز على تكامل API والأدوات التشغيلية. مبني حول خدمات Jitsi.',
    'دمج Jitsi API. إدارة مصادقة آمنة. التعامل مع المراقبة التشغيلية.',
    'مركزية مراقبة المؤتمرات. تبسيط الإدارة التشغيلية.',
    NULL,
    'https://github.com/M-Alhbyb/jitsi-dashboard',
    'published',
    false,
...
(
    ...
    'تطبيق تتبع مالي باستخدام HTMX لتفاعلات واجهة مستخدم مدفوعة من الخادم.',
...
تطبيق تتبع مالي بـ Django و HTMX لتفاعلات ديناميكية دون الاعتماد على أطر JavaScript.

يشمل إدارة المعاملات، تحليلات بالفئات، تحديثات رصيد فورية، ولوحات تحكم.',
    '["Django","HTMX","TailwindCSS","PostgreSQL"]',
    'بنية Django مع عرض من الخادم. تفاعلات HTMX ديناميكية. تصميم TailwindCSS. هيكل بيانات مالي.',
    'بنية أمامية خفيفة الوزن وقابلة للصيانة. أنماط واجهة مدفوعة من الخادم.',
    'بناء واجهات تفاعلية دون أطر ثقيلة. إدارة تحديثات فورية بمكونات من الخادم.',
    'تقديم تفاعلات فورية بتعقيد أمامي ضئيل. إظهار بنية واجهة فعالة.',
    NULL,
    'https://pasha-finance-app.onrender.com',
    'published',
    false,
...
(
    ...
    'إتقان 365',
    'etamkeen365-ar',
    'منصة تدخل تكيفي ودعم أسري للأطفال ذوي التحديات النمائية والسلوكية باستخدام أنظمة تقييم وتخطيط حتمية.',
    'إتقان 365 هي منصة تدخل تكيفي ودعم مقدمي الرعاية للأطفال ذوي التحديات النمائية والسلوكية والمعرفية والحسية.

تساعد المنصة مقدمي الرعاية والمتخصصين والإداريين على التعاون من خلال تقييمات منظمة وخطط تدخل وتتبع التقدم.

صُمم النظام بهندسة حتمية حيث يكون منطق التقدم والتقييمات والدرجات قائماً على قواعد يمكن تدقيقها.

تدعم المنصة دورات التدخل الكاملة: الإعداد، التقييمات، تقدير العمر الوظيفي، الخطط التكيفية، التنفيذ اليومي، إعادة التقييم، والمراقبة.

تفاصيل البنية:

- بنية Django متجانسة معيارية مع 20+ وحدة
- Django REST Framework مع طبقة خدمات
- React + TypeScript مع لوحات تحكم معيارية
- PostgreSQL مع انتقالات حالة آمنة
- Celery و Redis للجدولة والمهام
- دعم عربي RTL كامل',
    '["Django","Django REST Framework","React","TypeScript","PostgreSQL","Celery","Redis","Zustand"]',
    'بنية Django متجانسة معيارية مع 20+ وحدة. DRF مع طبقة خدمات. React + TypeScript مع لوحات تحكم معيارية. PostgreSQL مع انتقالات حالة آمنة. Celery و Redis للجدولة الحتمية. دعم عربي RTL.',
    'جاهزية إنتاجية ونشر تشغيلي. قابلية الصيانة والتدقيق والسلوك الحتمي. نشر تدريجي مع فلسفة التراجع أولاً.',
    'تصميم سير عمل تدخل حتمي. إدارة التقدم التكيفي مع الحفاظ على السلامة. بناء أنظمة إعادة تقييم.',
    'بناء منصة تدخل تكيفي للإنتاج. تنفيذ أنظمة إعادة تقييم وتتبع التزام. بنية تحتية قابلة للتوسع.',
    NULL,
    'https://etamkeen.net',
    'published',
    true,
...
(
    ...
    'منصة سعودية لإدارة حاويات الشحن اللوجستية تربط أصحاب البضائع بمقدمي الخدمات عبر سوق رقمي موحد.',
    'منفذ هي منصة لوجستية واسعة النطاق للسوق السعودي لربط أصحاب البضائع بمكاتب التخليص وشركات النقل والساحات.

تتمركز سير العمل اللوجستي عبر الموانئ والمطارات والمعابر عبر منصة ثنائية اللغة تدعم الإدارة والتفاوض والعقود والتواصل الفوري.

تشمل المنصة دردشة فورية وإشعارات ومصادقة OTP ودعم متعدد اللغات ولوحات تحليل وموظفين وتقارير.

تفاصيل البنية:

- مستودع واحد مع تطبيقات منفصلة
- Express.js مع Sequelize و MySQL
- Vue 3 مع Vite و TailwindCSS
- Socket.io للتواصل الفوري
- مصادقة JWT مع OTP
- CI/CD بـ GitHub Actions و PM2
- تعريب عربي أولاً مع RTL',
    '["Node.js","Express.js","MySQL","Sequelize","Vue 3","TailwindCSS","Socket.io","JWT"]',
    'مستودع واحد مع تطبيقات منفصلة. Express.js مع Sequelize و MySQL. Vue 3 مع Vite و TailwindCSS. Socket.io للتواصل الفوري. JWT مع OTP. CI/CD بـ GitHub Actions و PM2. تعريب مع RTL.',
    'CI/CD بـ GitHub Actions. بنية تحتية بـ PM2. نشر متعدد التطبيقات. لسير عمل لوجستي حقيقي.',
    'إدارة سير عمل عبر مقدمي خدمات متعددين. بناء واجهات ثنائية اللغة مع RTL. تنفيذ تواصل فوري.',
    'مركزية سير العمل اللوجستي. تمكين التنسيق بين جهات لوجستية. لوحات تحكم قابلة للتوسع.',
    NULL,
    'https://manfith.com',
    'published',
    true,
...
(
    ...
    'أعمال صيانة وتحسين منصة حقيقية شملت التصحيح وتحسين محركات البحث والتحسينات التشغيلية.',
    'آسيا للمباني هي منصة أعمال إنتاجية عملت عليها في التصحيح وتحسين محركات البحث والتحسينات التشغيلية.

ركز العمل على حل المشكلات في الواجهات وتحسين استقرار التطبيق وظهوره في محركات البحث والأداء.

تضمن العمل ضمن قاعدة Laravel و React مع الحفاظ على التوافق مع سير العمل الإنتاجي.

تفاصيل البنية:

- Laravel خلفي مع React أمامي
- سير عمل منصة إنتاجية حالية
- تحسينات SEO
- تصحيح عبر الطبقات',
    '["Laravel","React","SEO","MySQL"]',
    'Laravel مع React. سير عمل إنتاجي. تحسينات SEO. تصحيح عبر الطبقات.',
    'عمل مباشر على منصة حية. استقرار تشغيلي وتحسينات تدريجية. تصحيح دون تعطيل الأعمال.',
    'تشخيص وإصلاح مشكلات في نظام نشط. تحسين SEO. الحفاظ على الاستقرار أثناء الإصلاحات.',
    'تحسين استقرار المنصة. تعزيز SEO. المساهمة في استمرارية الأعمال.',
    NULL,
    'https://asiabuildings.sa/',
    'published',
    false,
...
(
    ...
    'منصة طلبات ونقاط بيع لمطعم مع إدارة التوصيل والاستلام باستخدام MERN stack و Docker.',
    'باهنوفلي جريل هي منصة مطعم إنتاجية تدعم الطلب عبر الإنترنت ونقاط البيع والتوصيل والاستلام.

تضمن المشروع طلباً إلكترونياً حيث يقدم العملاء طلباتاً مع خيار التوصيل أو الاستلام.

ركز عملي على تصحيح سير العمل وتنفيذ أنظمة التوصيل والاستلام عبر الخدمات الأمامية والخلفية.

بُنيت المنصة بـ MERN stack مع Docker.

تفاصيل البنية:

- MERN stack مع خدمات منفصلة
- MongoDB للبيانات
- React للواجهة
- Express.js و Node.js للخلفية
- Docker للتطوير والنشر
- تتبع التوصيل',
    '["MongoDB","Express.js","React","Node.js","Docker"]',
    'MERN stack مع خدمات منفصلة. MongoDB للطلبات. React للواجهة. Express.js و Node.js للخلفية. Docker للحاويات. تتبع توصيل.',
    'عمل على منصة مطعم حية. موثوقية واستقرار. إضافة ميزات مع الحفاظ على الأنظمة الحالية. Docker لاتساق البيئة.',
    'إصلاح مشكلات في سير عمل مطعم نشط. تصميم منطق التوصيل والاستلام. الحفاظ على استقرار الطلبات.',
    'توسيع المنصة بالتوصيل والاستلام. تحسين سير العمل. حل مشكلات إنتاجية.',
    NULL,
    'https://bahnhofligrill.ch/',
    'published',
    true,
